...
import com.example.examplemod.block.custom.GemPolishingStationBlock;
...
public class ModBlocks {
  ...
  public static final RegistryObject<Block> WTF =
      registerBlock(
          "wtf",
          () ->
              new SoundBlock(
  ...
  public static void register(IEventBus entBus) {
    BLOCKS.register(entBus);
  }
}

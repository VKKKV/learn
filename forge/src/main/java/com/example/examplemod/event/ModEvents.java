  ...
  public static void addCustomTrades(VillagerTradesEvent event) {
    ...
    if (event.getType() == VillagerProfession.LIBRARIAN) {
      ...
      ItemStack enchantedBook =
          EnchantedBookItem.createForEnchantment(new EnchantmentInstance(Enchantments.THORNS, 2));
      ...
      trades
          ...
          .add(
              (pTrader, pRandom) ->
                  new MerchantOffer(new ItemStack(Items.EMERALD, 32), enchantedBook, 2, 8, 0.02f));
    }

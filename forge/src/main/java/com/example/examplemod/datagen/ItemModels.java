...
public class ItemModels extends ItemModelProvider {
  ...
  protected void registerModels() {
    withExistingParent(
        ModItems.RHINO_SPANW_EGG.getId().getPath(), mcLoc("item/template_spawn_egg"));
  ...
  private ItemModelBuilder simpleBlockItemBlockTexture(RegistryObject<Block> item) {
    return withExistingParent(item.getId().getPath(), ResourceLocation.parse("item/generated"))
        .texture(
            "layer0",
            ResourceLocation.fromNamespaceAndPath(MyMod.MODID, "block/" + item.getId().getPath()));
  }
  ...
  private void trimmedArmorItem(RegistryObject<Item> itemRegistryObject) {
    final String MOD_ID = MyMod.MODID; // Change this to your mod id
          ...
          .forEach(
              entry -> {
                ...
                ResourceLocation trimResLoc =
                    ResourceLocation.parse(trimPath); // minecraft namespace
  ...
  private ItemModelBuilder handheldItem(RegistryObject<Item> item) {
    return withExistingParent(item.getId().getPath(), ResourceLocation.parse("item/handheld"))
        .texture(
            "layer0",
            ResourceLocation.fromNamespaceAndPath(MyMod.MODID, "item/" + item.getId().getPath()));
  }

  public void evenSimplerBlockItem(RegistryObject<Block> block) {
    this.withExistingParent(
        MyMod.MODID + ":" + ForgeRegistries.BLOCKS.getKey(block.get()).getPath(),
  ...
  public void fenceItem(RegistryObject<Block> block, RegistryObject<Block> baseBlock) {
    this.withExistingParent(
        ...
        .texture(
            "texture",
            ResourceLocation.fromNamespaceAndPath(
                MyMod.MODID, "block/" + ForgeRegistries.BLOCKS.getKey(baseBlock.get()).getPath()));
  }

...
public class BlockLootTables extends BlockLootSubProvider {
  ...
  protected void generate() {
    ...
    this.dropSelf(ModBlocks.WTF.get());
    ...
    this.add(
        ...
        block ->
            createCopperLikeOreDrops(
                ModBlocks.END_STONE_SAPPHIRE_ORE.get(), ModItems.SAPPHIRE.get()));

    this.add(
        ModBlocks.NETHER_SAPPHIRE_ORE.get(),
        block ->
            createCopperLikeOreDrops(ModBlocks.NETHER_SAPPHIRE_ORE.get(), ModItems.SAPPHIRE.get()));
    this.add(
        ModBlocks.DEEPSLATE_SAPPHIRE_ORE.get(),
        block ->
            createCopperLikeOreDrops(
                ModBlocks.DEEPSLATE_SAPPHIRE_ORE.get(), ModItems.SAPPHIRE.get()));
    ...
    this.add(
        ModBlocks.SAPPHIRE_SLAB.get(), block -> createSlabItemTable(ModBlocks.SAPPHIRE_SLAB.get()));
    this.add(
        ModBlocks.SAPPHIRE_DOOR.get(), block -> createDoorTable(ModBlocks.SAPPHIRE_DOOR.get()));
    ...
    LootItemCondition.Builder lootitemcondition$builder2 =
        LootItemBlockStatePropertyCondition.hasBlockStateProperties(ModBlocks.CORN_CROP.get())
            .setProperties(
                StatePropertiesPredicate.Builder.properties().hasProperty(CornCropBlock.AGE, 7))
            .or(

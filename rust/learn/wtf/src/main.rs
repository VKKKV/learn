...
//   // let slice: &[i32] = &arr.as_ref()[1..4];
//   let slice: &[i32] = arr.get(1..4).unwrap();
...
//     // let slice = &s[0..2];
//     // use utf8_slice;
//     // let slice = utf8_slice::slice(&s, 0, 1);
//     // let slice = &s[0..3];
//
//     assert!(slice == "你");
// }
...
//     let ch = first_character(&s).to_string();
//
//     s.clear(); // error!
...
// }
//
// fn greetings<T: Into<String>>(s: T) {
//     println!("{}", s.into())
// }
...
// fn main() {
//     // 填空：选择 false 以触发 panic 分支
//     let b = false;
//
//     let _v = match b {
//         true => 1,
//         // 发散函数(panic!)返回 ! (Never type)
//         // ! 可以被强制转换为任何类型，所以它能兼容 i32
//         false => {
//             println!("Success!");
